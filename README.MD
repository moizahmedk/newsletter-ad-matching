...
This project is inspired by real-world newsletter ad networks and demonstrates how production ML systems are designed, evaluated, and deployed.
...
- Features:
  - Content–ad semantic similarity
  - Historical ad CTR
- Metrics:
  - ROC-AUC
  - Log Loss
...
```
notebooks/Ad_Matching_ML_System_test.ipynb
```
...
│
├── notebooks/
│   ├── Ad_Matching_ML_System_train.ipynb
│   └── Ad_Matching_ML_System_test.ipynb
│
├── src/
│   ├── embeddings.py
│   ├── vector_store.py
...
Built to reflect the responsibilities of a **Senior Machine Learning Engineer** working on **high-volume ad and content systems**.
